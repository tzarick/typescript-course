...
function () {
  function User(data) {
    this.data = data;
    this.events = {}; // we don't know the names of the events (keys) at this time - use the [x: type] notation for dynamic names
  }
  ...
  User.prototype.on = function (eventName, callback) {
    ...
    var handlers = this.events[eventName] || []; // if undefined, an empty array will be assigned
